...
import { switchSearchIsShown } from 'redux/nav-reducer';
...
// Component to contain switcher to show/hide the search area
...
const SearchMenuSwitcher = ({ resized }) => {
  ...
  return (
    <div
      ...
      onClick={() => dispatch(switchSearchIsShown(!isSearch))}>
