...
// Get value whether current width of the container with all result tables is bigger than maximal allowed value for this container

export const getIsSideContainerBiggerThanMaxWidth = getState => {
